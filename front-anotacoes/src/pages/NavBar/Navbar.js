...
const modal = {
    ...
    boxShadow: 24,
    p: 4,
    boxShadow: '15px 15px 27px #252525, -15px -15px 27px #202020;',
...
export default function Navbar() {
    ...
    const logoutDialogRef = createRef();

    const getLogoutDialogRef = () => logoutDialogRef.current;

    const validateErrors = (values) => {
        let newError = {}

        if (!values.title) {
            newError.title = { error: true, helperText: "Titulo nao pode ser vazio" }
        }
    ...
    const submitForm = (values) => {
        ...
        let response = api.postTable(request).then((res) => {
    ...
    const handleOnButtonUserSettingsClick = () => {
        getLogoutDialogRef().show();
    }
                        ...
                        >
                            <TextField
                                ...
                                onChange={(e) => {
                                    ...
                                    titleFormik.handleChange(e)
                                }}
                                values={titleFormik.values.title}
                            />
                        </Box>
            ...
            <ul class="guilds-container">
                ...
                <a onClick={handleOpen}>
                    <li class="squircle green-boi">
                        ...
                        <div class="popper-boi">
                            <h4 class="popper-text">Create table</h4>
                        </div>
                    </li>
                </a>
                <li class="squircle green-boi">
            ...
            <section class="panel">
                <div class="user-info">
                    ...
                    <div class="name-tag-container">
                        <h1 class="username tipper-boi" data-tip="Click to copy username">theteachr</h1>
                        <div class="roller">
                ...
                <div class="button-container">
                    ...
                    <button
                        class="switcher tipper-boi"
                        data-tip="User Settings"
                        onClick={handleOnButtonUserSettingsClick}
                    >
                        <svg aria-hidden="false" width="20" height="20" viewBox="0 0 24 24">
